...
|----|-----------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | Exchange                                | This connector provides a robust, platform-independent, and simple interface for communicating with Microsoft Exchange 2007-2016 Server or Office 365 using Exchange Web Services (EWS).                                                                                                                         |
| 2  | File Content Extraction                 | The connector is used to extract content, metadata and artifacts from over 1500 file types such as MS Office, PDF, etc.                                                                                                                                                                                       |
| 3  | Fortinet FortiClient EMS                | This connector provides operations related to quarantine/unquarantine endpoints, get endpoint details, and is a security management solution that enables scalable and centralized management of multiple endpoints (computers).                                                                                 |
| 4  | Fortinet FortiEDR                       | This connector facilitates the automated operations related to events, forensics, and collectors.                                                                                                                                                                                                                 |
| 5  | Fortinet FortiGate                      | Fortinet FortiGate enterprise firewall provides high performance, consolidated advanced security and granular visibility for broad protection across the entire digital attack surface.                                                                                                                           |
| 6  | VirusTotal                              | This connector facilitates automated operations such as scanning and analyzing suspicious files and URLs and retrieving reports from VirusTotal for files, IP addresses, and domains.                                                                                                                            |
| 7  | Whois RDAP                              | Whois RDAP is a service that enables you to retrieve information about the location of IP addresses, servers, or websites. You can find out the owner of the Internet resource and their contact details.                                                                                                        |
...
| #  | Widgets                            | Description                                                                                                                                                           |
|----|------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | Indicator Extraction Configuration | This widget assists user in configuring *Manage Indicator Exclusion List* settings within the FortiSOAR environment.                                                  |
| 2  | Custom Picklist Message            | This widget helps display custom messages above the record details page.                                                                                              |
| 3  | Fields Of Interest                 | This widget helps users select fields to display in a module's detailed view, regardless of the *Visibility Constraint*.                                              |
| 4  | Incident Correlations              | This widget displays the correlation graph of an incident.                                                                                                            |
...
| 7  | Picklist as Phases                 | This widget displays picklist values as phases in a flow diagram format. Each phase represents a specific state or stage in a process.                                |
...
| 13 | Setup Guide                        | The setup guide launches automatically on first login, for new installations, and contains a list of tasks whose completion is recommended as part of first time setup.                       |
...
| 6  | Extract Indicators (Alerts)                             | Extracts and creates indicators from the specified data and then enriches specific fields in alerts with the indicator data.                             |
| 7  | Extract Indicators (Incidents)                          | Extracts and creates indicators from the specified incident records and then enriches specific fields in alerts with the indicator data.                 |
...
| 18 | Action - Host - Block (Specified by User)             | Creates indicators for the host specified by the user, blocks the host on the firewall, and also marks the indicator as blocked. The indicator is also linked to the record on which the playbook is triggered.                             |
...
| 29 | Action - URL - Block (Specified by User)              | Creates indicators for the specified 'URL', blocks the URL on the firewall, and marks the indicator as blocked. The indicator is also linked to the record on which the playbook is triggered.                                              |
| 30 | Action - URL - Unblock (Specified by User)            | Creates indicators for the specified 'URL', unblocks the URL on the firewall, and marks the indicator as unblocked. The indicator is also linked to the record on which the playbook is triggered.                                          |
...
| 37 | Add Exclude List to Keystore                          | Add IP, Domain and URL in key store.                                                                                                                                                                                                        |
| 38 | Add Exclude List to Keystore - Update Keystore Record | Updates exclude list values in key store.                                                                                                                                                                                                   |
...
| #  | Playbook Name                                    | Description                                                                                                                                                                                                       |
|----|--------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | Alert - Close Corresponding SIEM Alert           | Closes the alert on the corresponding SIEM when an alert is closed in FortiSOAR.                                                                                                                                  |
| 2  | Alert - Escalate To Incident                     | Escalates the selected alert to an incident.                                                                                                                                                                      |
| 3  | Alert - Escalate to Incident (Link Relations)    | Extracts related records and assigns them to a created incident.                                                                                                                                                  |
| 4  | Alert - Escalate To Incident (No Trigger)        | Creates a new incident with the specified inputs and links the alert(s) to the newly created incident.                                                                                                            |
| 5  | Alert - Escalate To Incident (Referenced)        | Creates a new incident with the given inputs and links the alert(s) to the newly created Incident.                                                                                                                |
| 6  | Alert - Set Assigned Date (upon creation)        | Updates the assigned date of the alert when a person is assigned to the alert.                                                                                                                                    |
| 7  | Alert - Set Assigned Date (upon reassignment)    | Updates the assigned date of the alert when a person is reassigned to the alert.                                                                                                                                  |
| 8  | Alert - Set Resolved Date                        | Updates the resolved date of an alert when its state is marked as "Closed".                                                                                                                                       |
| 9  | Assign Random User to Unassigned Alerts          | Auto assigns alerts if their assignments were missed during alert creation.                                                                                                                                       |
| 10 | Assign Random User to Unassigned Incidents       | Auto assigns incidents if their assignments were missing during incident creation.                                                                                                                                |
| 11 | Create IOC Extracted From CSV File               | It is subroutine of "Ingest IOC From CSV File" playbook, which will create IOC extracted from CSV File                                                                                                            |
| 12 | Incident - Set Assigned Date (upon creation)     | Updates the assigned date of an incident when a lead is assigned to the incident.                                                                                                                                 |
| 13 | Incident - Set Assigned Date (upon reassignment) | Updates the assigned date of the incident when a lead is reassigned to the incident.                                                                                                                              |
| 14 | Incident - Set Phase Dates                       | Updates an incident's phase dates based on incident phase.                                                                                                                                                        |
| 15 | Incident - Set Resolved Date                     | Updates the resolved date of an incident when its state is marked as "Resolved".                                                                                                                                  |
| 16 | Incident (Post Create) Phase Change              | Sets an incident's phase dates upon incident creation.                                                                                                                                                            |
| 17 | Incident (Post Update) Phase Change              | Updates an incident's phase dates when incident phase is changed.                                                                                                                                                 |
| 18 | Indicator - Check Expiry Status                  | Checks periodically for the expiry date of the indicator and marks it as expired, if matched.                                                                                                                     |
| 19 | Indicator - Set Default Expiry Date              | Sets the default expiry date when an indicator is created.                                                                                                                                                        |
| 20 | Indicator - Set First Seen Date                  | Sets the first seen date when an indicator is created.                                                                                                                                                            |
| 21 | Indicator - Set Last Seen Date                   | Tracks the occurrence of an indicator by updating the last seen date.                                                                                                                                             |
| 22 | Ingest IOC From CSV File                         | Ingest and create indicators from IOC listed in CSV file. Incase CSV file has huge number of records , its recommended that celery soft timeout and tasks timeout values are updated. Refer product documentation |
| 23 | Link Similar Alerts                              | Links all selected similar alerts with the parent alert.                                                                                                                                                          |
| 24 | Link Similar Incidents                           | Links all selected similar incidents with the parent incident.                                                                                                                                                    |
| 25 | Link Similar Indicators                          | Links all selected similar indicators with the parent indicator.                                                                                                                                                  |
| 26 | Notify Blocked Indicator Status to Linked Alerts | Adds a note about an indicator being blocked.                                                                                                                                                                     |
| 27 | Prompt when Indicator linked is to Campaign      | Notifies an analyst via manual input when an indicator is linked to a campaign.                                                                                                                                   |
| 28 | Resolve Alert                                    | Marks the specified Security Alert as closed.                                                                                                                                                                     |
| 29 | Set Prompt to an Alert                           | Displays a prompt on alerts when an indicator is linked to campaign.                                                                                                                                              |
...
| 2 | Get Paginated Records | Gets paginated records data and appends them in a .CSV file. This playbook is a reference playbook for 'Export as CSV'. |
...
| 4  | NotifyNewly Linked Team                     | Sends an email notification to the new team that has been linked to the War Room record.                                                                        |
| 5  | NotifyNewly Linked User(s)                  | Sends an email notification to the new users that have been linked to the War Room record.                                                                      |
...
| 7  | Send EmailNotification                      | Fetches details of War Room owners and user owners and sends them an email notification related to any changes in the war room record.                          |
...
| 13 | Set up War Room from Incidents (Referenced) | Establishes a War Room based on the selected incident(s)                                                                                                        |
...
| 2  | Alert - Record Closure Validation                   | Ensures alerts cannot be closed if tasks or manual inputs are incomplete, prompting user confirmation for reopening or closure.                                    |
| 3  | Cascade Permissions to all Related Records          | Cascades the team of the record to all of its related records. Earlier known as Fetch and Link Team to Related Records                                             |
| 4  | Create and Link Asset                               | Creates an asset (if it doesn't exist already), and links it to the specified email, alert, or incident record.                                                    |
| 5  | Create and Link Indicator                           | Create an indicator (if it doesn't exist already), and link it to the specified email, alert, or incident record.                                                  |
| 6  | Download and Create Attachment                      | Downloads the file from a specified URL and creates an attachment record for the same.                                                                             |
| 7  | Incident - Record Closure Validation                | Ensures incidents cannot be closed if tasks or manual inputs are incomplete, prompting user confirmation for reopening or closure.                                 |
| 8  | Indicator - Import Bulk Indicator                   | Extract Indicators from specified text                                                                                                                             |
| 9  | Manage Closed Alerts                                | Identifies closed alerts from the past seven days.                                                                                                                 |
| 10 | Manage Closed Alerts - Remove Pending Manual Inputs | Retrieves associated pending manual inputs and deletes them.                                                                                                       |
| 11 | Scheduled Configuration Export                      | Export template name and email address to be updated in the 'Configuration' step. Can be used to schedule Configuration Export and send it as an email.            |
