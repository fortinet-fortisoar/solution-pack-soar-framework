...
| 12     | Indicator (Type Registry) - Get Reputation <sup>New</sup>                                      | Retrieves the reputation of indicators of type ‘Registry’ using configured threat intelligence tools.                                                     |
| 13     | Enrich Indicators (Type All) <sup>New</sup>                                    | Get indicator reputation from all available pluggable enrichment playbooks.                                                                              |
| 14     | Enrich Indicator (Type IP) <sup>New</sup>                                      | Pre-process the IP Address indicator                                                                                                                     |
| 15     | Update/Initialize Indicator Enrichment Global Variables <sup>New</sup>         | Update enrichment playbooks list global variable based on indicator type defined as param tag                                                            |
| 16     | Retrieve Configured Enrichment Connectors <sup>New</sup>                       | Retrieve the configured enrichment connectors and return their playbook IRI's                                                                            |
| 17     | Delete Enrichment Global Variables <sup>New</sup>                              | Delete the pluggable enrichment global variables                                                                                                         |
