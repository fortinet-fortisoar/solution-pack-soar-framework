...
| 5  | Alert - Escalate To Incident (Referenced)![](./res/icon-new.svg) | Creates a new incident with the given inputs and links the alert(s) to the newly created Incident.                                                                                                                |
