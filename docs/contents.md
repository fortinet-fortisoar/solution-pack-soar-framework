...
| 6  | Extract Indicators (Alerts)![](./res/icon-renamed.svg)  | Extracts and creates indicators from the specified data and then enriches specific fields in alerts with the indicator data.                             |
| 7  | Extract Indicators (Incidents)![](./res/icon-new.svg)   | Extracts and creates indicators from the specified incident records and then enriches specific fields in alerts with the indicator data.                 |
...
| # | Playbook Name                                                                                        | Description                                                                                                                                                                                                                                                       |
|---|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 | Compute Alert Priority Weight(Post Update)![](./res/icon-inactive.svg)                               | Computes and sets the priority weight for an alert, when the alert is updated. The priority weight is calculated based on indicators related to the alert.                                                                                                        |
| 2 | Compute Alert Priority Weight(Post Update - Indicator Linked)![](./res/icon-inactive.svg)            | Computes and sets the priority weight for an alert, when an indicator related to the alert is updated. The priority weight is calculated based on indicators related to the alert.                                                                                |
| 3 | Compute Alert Priority Weight(Post Update - Indicator Reputation Update)![](./res/icon-inactive.svg) | Computes and sets the priority weight for an alert, when the reputation of an indicator is updated. The priority weight is calculated based on indicators related to the alert.                                                                                   |
...
| 34 | Add to Exclude List ![](./res/icon-removed.png)                               | Add IP, Domain and URL in Excluded Global Variables                                                                                                                                                                                         |
...
| 37 | Add Exclude List to Keystore ![](./res/icon-new.svg)                          | Add IP, Domain and URL in key store.                                                                                                                                                                                                        |
| 38 | Add Exclude List to Keystore - Update Keystore Record ![](./res/icon-new.svg) | Updates exclude list values in key store.                                                                                                                                                                                                   |
