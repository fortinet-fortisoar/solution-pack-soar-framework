...
| 12      | Key Store<sup>NEW</sup> | Key Store module is a place to store records that contains key value pair |
...
| 44     | Link Similar Emails<sup>Removed</sup>                                                     | Links all selected similar emails with the parent email.                                                                                                                                                          |
...
| 9 | Create Communication Record (Alert)<sup>NEW</sup> | Creates a record in the communications module and links it to an alert based on the information provided by the security analyst. |
| 10 | Create Communication Record (Incident)<sup>NEW</sup> | Creates a record in the communications module and links it to an incident based on the information provided by the security analyst. |
