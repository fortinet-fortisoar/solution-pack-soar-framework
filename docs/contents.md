...
| 16 | URLScan.io                              | URLScan.io provides a service that analyzes websites and the resources they request. URLScan.io provides actions like search domain, ip, hash scan URL and retrieve report of scanned url.                                                                                                                       |
| 17 | VirusTotal                              | This connector facilitates automated operations such as scanning and analyzing suspicious files and URLs and retrieving reports from VirusTotal for files, IP addresses, and domains.                                                                                                                            |
| 18 | VMWare Carbon Black EDR                 | This connector facilitates automated operation related to endpoint protection like isolate endpoint, unisolate endpoint, hunt file, terminate process etc. with VMWare Carbon Black EDR server.                                                                                                                  |
| 19 | Whois RDAP                              | Whois RDAP is a service that enables you to retrieve information about the location of IP addresses, servers, or websites. You can find out the owner of the Internet resource and their contact details.                                                                                                        |
...
| #  | Widgets                                                   | Description                                                                                                                                                           |
|----|-----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | Indicator Extraction Configuration![](./res/icon-new.svg) | This widget assists user in configuring *Exclude Indicators List* settings within FortiSOAR environment.                                                              |
...
| 7  | Picklist as Phases![](./res/icon-new.svg)                 | This widget displays picklist values as phases in a flow diagram format. Each phase represents a specific state or stage in a process.                                |
...
| 13 | Setup Guide![](./res/icon-new.svg)                        | The setup guide launches automatically on first login and contains a list of tasks whose completion is recommended as part of first time setup.                       |
