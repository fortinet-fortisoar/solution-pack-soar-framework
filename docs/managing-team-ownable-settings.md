...
- **Spears** work with Alert, Case, and Indicator module.

- **Forts** analyze alerts based on extracted indicators and **Spears** are responsible for handling cases escalated by Forts.
